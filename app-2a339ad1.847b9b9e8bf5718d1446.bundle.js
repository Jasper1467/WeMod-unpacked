    ...
    83202: (e, t, a) => {
      ...
      let p = class {
        ...
        #i(e) {
          ...
          if (this.trainerSupportsActivateOnLoad(t.blueprint)) {
            const a = this.gamePreferences[t.gameId]?.saveCheats;
            a?.enabled &&
              t.blueprint.cheats.forEach(async (t) => {
                if (this.cheatSupportsActivateOnLoad(t)) {
                  const s = a.trainerState[t.target];
                  void 0 !== s && (await e.setValue(t.target, s, 5));
                }
              });
          }
          e.onValueSet((e) => {
        ...
        async saveValue(e, t, a) {
          this.enableSaveCheatsByDefault &&
            void 0 === this.gamePreferences[e]?.saveCheats?.enabled &&
            (await this.enable(e, "save_cheats_enabled_by_default")),
