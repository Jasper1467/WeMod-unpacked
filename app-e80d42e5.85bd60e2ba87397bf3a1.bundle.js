  ...
  [9450],
  {
        ...
        p = class {
            ...
            (navigator.sendBeacon = (t, s) =>
              ...
              "string" == typeof s
                ? s
                    ...
                    .every((s) => e(`${t}&${s}`))
                : e(t, s)),
              (d.gtagDocument = new f(new m(r.DA))),
              await this.#A();
          }
          async #A() {
            try {
          ...
          #G(e) {
            (this.#C = Object.assign(this.#C, e)),
              this.#R("config", r.uZ.ga.V, this.#C);
          }
          event(e, t = {}) {
          ...
          screenView(e, t) {
            (this.#_ && e === this.#_.name && t === this.#_.class) ||
              (this.#G({ firebase_screen: e, firebase_screen_class: t }),
              this.#e.isInTraySinceStartup ||
                this.event("screen_view", {
                  firebase_previous_screen: this.#_?.name ?? null,
                  firebase_previous_class: this.#_?.class ?? null,
                }),
              (this.#_ = { name: e, class: t }));
          }
        };
      p = (0, a.gn)(
        [
      ...
      let v = class {
          ...
          this.#x.size > 0 &&
            ...
            (e
              ? (f.debug("Restored from system tray. Resuming watcher"),
                (this.#O = p.$L),
                this.#F())
              : (this.#O = (0, p.rk)(() => this.#F(), 1e4)));
        }
        async #B(e = !1) {
          if (this.#V || e) {
            this.#K();
            try {
              await this.refreshApps(), await this.#H();
            } finally {
              this.#N
                ? ((this.#N = !1), this.#B(!0))
                : (this.#V = (0, p.rk)(() => this.#B(), (0, m.i)(2, 3)));
            }
          }
        }
        watchGame(e) {
        ...
        async #H() {
          ...
          for (let t, n = 0; (t = e.slice(n, n + 15)).length > 0; n += 15)
            await Promise.all(
              t.map(async (e) => {
                const t = await this.#X(e, this.installedApps, s);
                null !== t && ((a[e.id] = t), i++);
              })
            ),
      ...
      let T = class {
        ...
        #pe(e) {
          ...
          a &&
            ...
            this.#oe.event("notification_click", { type: i, gameId: r }, b.$);
        }
      };
      T = (0, a.gn)(
        [
    ...
    16943: (e, t, s) => {
      ...
      let g = class {
        ...
        launch(e, t, s) {
          this.#me
            .launchAndForget(e)
            .then(() => {
              this.#oe.event("game_launch", this.#fe({}, e, t, s), n.$),
      ...
      g = (0, a.gn)(
        [
          ...
          (0, a.w6)("design:paramtypes", [h.hM, n.c, r.yh, o.x]),
        ],
        g
      );
    },
    65793: (e, t, s) => {
      ...
      u = (0, a.gn)(
        [
          ...
          (0, a.w6)("design:paramtypes", [r.yh, h.oc, n.K, o.f, g.c]),
        ],
        u
      );
    },
    ...
    87632: (e, t, s) => {
      ...
      let T = class {
          ...
          this.#xe(),
            (this.#n = new m.K4([
              ...
              this.#Me.onCheatStatesChanged((e) => {
                if (this.#Ne) {
                  const t = this.#Ne.getMetadata(o.z9).info;
        ...
        #Be() {
          0 === this.#Ie.connections && this.#Fe("disconnected");
        }
        #Fe(e) {
          e !== this.status &&
        ...
        #Ue(e) {
          switch (e.type) {
            case "broadcast_request":
              ...
              break;
            case "trainer_value":
              e.stateId === this.#Oe && this.#Ne?.isActive()
                ? this.#Ne.setValue(e.name, e.value, 4, e.cheatId)
                : this.#Je();
              break;
            case "cheat_instructions_read":
              this.#Ve.markRead(e.cheatId, e.instructions);
          }
        }
        #xe() {
          this.#Oe = Date.now();
        ...
        #Je() {
          if (this.#Ie.connected)
            if (this.#Ne) {
              const e = this.#Ne.getMetadata(o.z9).info;
              this.#He({
                type: "trainer_state",
                stateId: this.#Oe,
                blueprint: {
                ...
                strings: this.#ze(e.gameId),
                values: this.#Ne.isActive()
                  ? Object.fromEntries(this.#Ne.values.entries())
                  : null,
