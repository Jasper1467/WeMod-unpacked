...
(global.webpackChunkWeMod = global.webpackChunkWeMod || []).push([
  [4837],
  {
    ...
    "dashboard/resources/elements/activity.html": (e, t, o) => {
      ...
      var i = o(27091),
        a = o.n(i),
        n = new URL(o(47254), o.b),
        s = new URL(o(4991), o.b),
    ...
    "dashboard/resources/elements/featured-content.html": (e, t, o) => {
      ...
      var i = o(27091),
        a = o.n(i),
        n = new URL(o(4265), o.b),
        s = new URL(o(49714), o.b);
      const r =
    ...
    "dashboard/dashboard": (e, t, o) => {
      ...
      let l = class {
        ...
        attached() {
          this.#e.screenView("Dashboard", "Dashboard");
        }
        bind() {
      ...
      (0, i.gn)(
        ...
        (l = (0, i.gn)(
          [
            ...
            (0, a.autoinject)(),
            (0, i.w6)("design:paramtypes", [s.c, n.F0, r.AD]),
          ],
          l
        ));
    },
      ...
      let m = class {
        ...
        #s() {
          if (((this.selectedFeed = "all"), this.myGamesFeed[0])) {
            const e = Date.now(),
              t = (0, s.Z)(new Date(this.myGamesFeed[0].happenedAt), e) <= 7,
              o = (0, s.Z)(new Date(this.lastMyGamesActivityFeedSeen), e) <= 7;
            !t ||
          ...
          if (!this.followInProgress) {
            ...
            try {
              ...
              await this.#a.followGames(o, 2),
                ...
                this.#e.event("my_games_dashboard_follow", {}, r.$),
                (this.followed = !0);
            } catch {
            } finally {
      ...
      (0, i.gn)(
        ...
        (m = (0, i.gn)(
          [
            ...
            (0, a.autoinject)(),
            (0, i.w6)("design:paramtypes", [c.AD, n.yh, r.c, d.r]),
          ],
          m
        ));
    },
    "dashboard/resources/elements/announcements": (e, t, o) => {
      ...
      let r = class {
        ...
        bind() {
          (this.#c = this.#d.onReevaluationRequired(() => this.#n())),
            this.#n();
        }
        unbind() {
      ...
      r = (0, i.gn)(
        [
          (0, s.b)({ selectors: { catalog: (0, s.g)("catalog") } }),
          (0, a.autoinject)(),
          (0, i.w6)("design:paramtypes", [n.W]),
        ],
        r
      );
    },
    "dashboard/resources/elements/dashboard-free-games": (e, t, o) => {
      o.r(t), o.d(t, { DashboardFreeGames: () => s });
      var i = o(70655),
        a = o("aurelia-framework"),
        n = o(74036);
      class s {
        constructor() {
          this.ALL_GAMES_CONFIG = n.Bd;
        }
      }
      (0, i.gn)(
        [
    ...
    "dashboard/resources/elements/featured-content": (e, t, o) => {
      ...
      let c = class {
        ...
        bind() {
          this.#n(), this.change(this.featuredContent[0]);
        }
        catalogChanged() {
          this.#n();
        }
      ...
      c = (0, i.gn)(
        [
          ...
          (0, a.autoinject)(),
          (0, i.w6)("design:paramtypes", [n.c, s.W]),
        ],
        c
      );
    },
    "dashboard/resources/elements/objectives-progress-bar": (e, t, o) => {
      o.r(t), o.d(t, { ObjectivesProgressBar: () => n });
      var i = o(70655),
        a = o("aurelia-framework");
      class n {}
      (0, i.gn)(
    ...
    "dashboard/resources/elements/objectives": (e, t, o) => {
      ...
      let A = null,
        ...
        $ = (i = class {
          ...
          attached() {
            (this.#h = new j.K4().push(
              this.#u.onStatusChanged((e) => {
                e === p.d.Connected && ((i.remoteHasConnected = !0), this.#n());
              })
            )),
              this.#u.status === p.d.Connected &&
                ((i.remoteHasConnected = !0), this.#n());
          }
          detached() {
          ...
          toggleShowCompleted() {
            this.completedCount >= this.completableCount &&
              ((this.showCompleted = !this.showCompleted), this.#n());
          }
          #w(e) {
          ...
          #x() {
            ...
            if (
              ...
              const e = Object.fromEntries(
                ...
                t = JSON.stringify(e);
              t !== A &&
                ((A = t), this.#e.event("objective_completion", e, l.$));
            }
          }
        });
      (0, a.gn)(
        ...
        (0, a.gn)(
          [
            (0, s.computedFrom)("completableCount", "completedCount"),
