  ...
  [2366],
  {
    ...
    "app/resources/elements/app-header-search": (e, t, i) => {
      ...
      let g = class {
        ...
        handleBlur(e) {
          e.relatedTarget !== this.closeButtonEl &&
    ...
    "app/resources/elements/discord-tooltip": (e, t, i) => {
      ...
      (0, o.gn)(
        ...
        (n = (0, o.gn)(
          [(0, r.autoinject)(), (0, o.w6)("design:paramtypes", [s.cp, a.B])],
          n
        ));
    },
      ...
      let l = class {
        ...
        attached() {
          this.#E = new n.K4()
            ...
            .push(
              this.#R.subscribe("open-overlay-tooltip", () =>
                this.openTooltip()
              )
            );
        }
        ...
        tooltipOpenChanged(e, t) {
          !0 === t &&
            !1 === e &&
            ((this.highlight = !1), this.#R.publish("overlay-tooltip-closed"));
        }
        get isConnected() {
    ...
    "app/resources/elements/overlay-tooltip": (e, t, i) => {
      ...
      (0, o.gn)(
        ...
        (l = (0, o.gn)(
          [
            (0, r.autoinject)(),
            (0, o.w6)("design:paramtypes", [Element, a.F0, n.cp]),
          ],
          l
        ));
    },
