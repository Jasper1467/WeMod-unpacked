  ...
  [2430],
  {
    ...
    "cheats/game-collection": (e, t, a) => {
      ...
      var i = a(70655),
        ...
        l = a(74036),
        d = a(29242),
        g = (a("resources/elements/layout-toggle"), a(339)),
        p = a(93082),
        h = a(27170),
        m = a(9288);
      const b = [
      ...
      let f = class {
        ...
        activate(e, t, a) {
          this.#c = e.slug;
          const i = u.find((e) => e.slug === this.#c);
          i && (this.config = i), a.queryParams.search || this.#d();
        }
        deactivate() {
        ...
        async #d() {
          await (0, g.UC)();
          const e = {
            state: this.searchTerms ? "Search Results" : "All",
            installed_games: Object.keys(this.installedGameVersions).length > 0,
            layout: this.layout,
          };
          this.#r.screenView({
            name: this.selectedFeed.analyticsName || this.config.analyticsName,
            class: this.config.analyticsName,
            params: e,
          });
        }
        layoutChanged(e, t) {
      ...
      (0, i.gn)(
        ...
        (f = (0, i.gn)(
          [
            ...
            (0, p.b)({
              selectors: {
                gameCollectionPreferences: (0, p.g)(
                  "gameCollectionPreferences"
                ),
                installedGameVersions: (0, p.g)("installedGameVersions"),
              },
            }),
            (0, i.w6)("design:paramtypes", [c.cp, n.F0, l.AD, r.h, s.yh]),
          ],
          f
        ));
    },
    "cheats/game": (e, t, a) => {
      ...
      let E = class {
        ...
        async createProject(e, t, a, i) {
          ...
          const o = `${r}\\Trainer.sln`,
            n = `${r}\\Trainer.vcxproj`;
          "x64" !== a && (await Promise.all([this.#p(n, a), this.#p(o, a)])),
            await this.#h(n, t);
          try {
      ...
      let I = class {
        ...
        async createLocalProject(e) {
          ...
          if (null === i) return;
          const r = await this.#b.createProject(
            a,
            e.repoPath,
            "x86" === i ? "Win32" : "x64",
            e.fileSafeTitleName
      ...
      let L,
        V = class {
          ...
          attached() {
            const e = new ResizeObserver(() => this.#j());
            e.observe(this.trainerTabsEl),
              (this.#R = new F.K4()
                .pushEventListener(window, "resize", () => this.#L(!1))
                ...
                .push(this.#x.onLocaleChanged(() => this.#z()))),
              this.#j(),
              this.#z();
          }
          detached() {
          ...
          unbind() {
            (this.#N = !1),
              this.#I?.cancel(),
              (this.#I = null),
              this.#_.cancelVisibleTrainer();
          }
          #z() {
            this.canHelpTranslate = !this.#x.isDefaultLanguage();
          }
          async creatorModeChanged(e, t) {
            if (this.#N && void 0 !== t) {
              const e = this.selectedTrainer?.id;
              !1 === (await this.loadTrainer(void 0, !1)) &&
                (this.creatorMode && e ? await this.loadTrainer(e) : this.#O());
            }
          }
          catalogChanged() {
            this.#M();
          ...
          async loadTrainer(e, t = !0) {
            ...
            const r = await this.#k.fetch(this.gameId, e);
            return a.canceled
              ? null
              : r
          ...
          async launch(e, t, a) {
            const i = this.selectedTrainer;
            if ("remote" !== a) {
              if ((await this.#H()) && !(await this.#q.open()).wasCancelled)
                return;
              if (!(await this.#K())) return;
              ...
              if (
                ...
                const e =
                  (await this.#w.yesNo("game.cheats_might_not_work_dialog")) ===
                  x.DialogResult.Yes;
                if (
                  (this.#$.publish(new f._V(this.gameId, t ?? null, i.id, e)),
                  !e)
                )
                  return;
              }
              ...
              if (
                (await this.#F.showDialog()) &&
                (await this.#S.hasOpenDialog())
              )
                return;
              if (
                (await this.#D.showDialogBeforeTrainer()) &&
                (await this.#S.hasOpenDialog())
              )
                return;
            }
            if (i === this.selectedTrainer)
              try {
                await this.#T.launch(new j.z9(this.selectedTrainer, e, t, a));
              } catch (e) {
                if (!(e instanceof j.w6)) throw e;
              }
          }
          trainerPanelClosedChanged() {
            this.trainerPanelClosed && ((this.selectedTab = null), this.#L(!1));
          }
          adActiveChanged() {
          ...
          async selectTab(e) {
            (this.proAutoPopupOpen && "pro" === e) ||
              ...
              this.proAutoPopupOpen && this.#W(),
              (this.previousSelectedTab = this.selectedTab),
              (this.selectedTab = e)),
              this.#L(!0);
          }
          async selectedTabChanged() {
            if (((L = this.selectedTab), "history" === this.selectedTab))
              try {
                this.trainerHistory = await this.#v.getTrainerHistoryForGame(
                  this.gameId
                );
              } catch {
                try {
                  this.trainerHistory = await this.#G();
                } catch {}
              }
          }
          closeSelectedTab() {
          ...
          trainerNotesReadChanged() {
            this.selectedTrainer?.blueprint.notes
              ? ((this.#E = (0, C.Wu)(this.selectedTrainer.blueprint.notes)),
                (this.selectedTrainerNotesRead =
                  this.trainerNotesRead[this.selectedTrainer.id] === this.#E))
              : ((this.#E = null), (this.selectedTrainerNotesRead = !0));
          }
          toggleNotes() {
          ...
          async #K() {
            ...
            return (
              "game.play" ===
                ...
                })) && (await this.#s.dispatch(P.yo, e.id, this.#E), !0)
            );
          }
          accountChanged() {
            this.#U(),
              this.selectedTab &&
                !this.#B(this.selectedTab) &&
                this.selectTab("info");
          }
          ...
          async #U() {
            this.proAutoPopupOpen = await this.#X();
          }
          async #X() {
          ...
          helpTranslate() {
            let e;
            try {
              e = this.#v.getGameTranslationUrl(
                this.gameId,
                this.#x.getEffectiveLocale().toString()
              );
            } catch {
          ...
          async createDesktopShortcut() {
            await this.#C.create(this.gameId, "game_info_panel"),
          ...
          async #H() {
            return (
              ...
              (await this.#A.trigger(N.EXPERIMENT_KEY)) > 0
            );
          }
        };
      (0, i.gn)(
