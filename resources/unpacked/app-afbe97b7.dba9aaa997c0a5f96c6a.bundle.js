...
(global.webpackChunkWeMod = global.webpackChunkWeMod || []).push([
  [3770],
  {
    "dialogs/selection-dialog.scss": (e, o, t) => {
    ...
    "dialogs/update-dialog.scss": (e, o, t) => {
      t.r(o), t.d(o, { default: () => u });
      var i = t(8081),
        a = t.n(i),
        l = t(23645),
    ...
    "dialogs/webview-dialog.scss": (e, o, t) => {
    ...
    "dialogs/welcome-mat-dialog.scss": (e, o, t) => {
      t.r(o), t.d(o, { default: () => u });
      var i = t(8081),
        a = t.n(i),
        l = t(23645),
    ...
    "dialogs/selection-dialog.html": (e, o, t) => {
    ...
    "dialogs/update-dialog.html": (e, o, t) => {
    ...
    "dialogs/webview-dialog.html": (e, o, t) => {
      t.r(o), t.d(o, { default: () => i });
      const i =
    ...
    "dialogs/welcome-mat-dialog.html": (e, o, t) => {
      t.r(o), t.d(o, { default: () => i });
      const i =
    ...
    "dialogs/selection-dialog": (e, o, t) => {
      t.r(o),
        t.d(o, { SelectionDialog: () => r, SelectionDialogService: () => s });
      var i = t(70655),
        a = t("aurelia-dialog"),
      ...
      let r = class {
        ...
        activate(e) {
          this.config = e;
          const o = !0 === e.multiselect ? {} : e.multiselect;
          if (
            ((this.minSelections = (o && o.minSelections) || 1),
            (this.maxSelections = o ? o.maxSelections || e.options.length : 1),
            Array.isArray(e.defaultSelections))
          ) {
            const o = e.defaultSelections.map((e) => e.toString());
            this.selections = e.options
              .filter((e) => o.includes(e.toString()))
        ...
        #e() {
          ...
          if (!this.#t()) return !0;
          const e = (0, d.kJ)(this.customSelection) || "";
          return (
            e.length > 0 && e.length <= this.config.customSelection.maxLength
          );
        }
        #o() {
          if (!this.config.detailsField) return !0;
          if (this.config.detailsField.lastOptionOnly && !this.#t()) return !0;
          const e = (0, d.kJ)(this.details) || "";
          return (
            e.length >= (this.config.detailsField.minLength || 0) &&
            e.length <= this.config.detailsField.maxLength
          );
        }
        ...
        submit() {
          this.controller.ok({
            ...
            selections: this.selections.map((e) => e.toString()),
        ...
        toggleSelection(e) {
          this.config.multiselect
            ? this.selections.includes(e)
              ? (this.selections = this.selections.filter((o) => o !== e))
              : this.selections.length < this.maxSelections &&
                (this.selections.push(e),
                (this.selections = this.selections.slice(0)))
            : this.selections.includes(e) || (this.selections = [e]);
        }
        #t() {
          const e = this.config.options[this.config.options.length - 1];
    ...
    "dialogs/update-dialog": (e, o, t) => {
      t.r(o), t.d(o, { UpdateDialog: () => s, UpdateDialogService: () => c });
      var i = t(70655),
        a = t("aurelia-dialog"),
        l = t("aurelia-framework"),
        n = t(9980),
      ...
      let s = class {
        #i;
        constructor(e, o) {
          (this.controller = e), (this.#i = o);
        }
        activate(e) {
          this.content = this.#i.render(e.content);
        }
      };
      s = (0, i.gn)(
        [
    ...
    "dialogs/webview-dialog": (e, o, t) => {
      t.r(o), t.d(o, { WebviewDialog: () => y, WebviewDialogService: () => _ });
      var i = t(70655),
        a = t("aurelia-dialog"),
        ...
        f = t(66302),
        w = t(84620),
        v = t("dialogs/payment-processing-dialog");
      let y = class {
        #a;
        #l;
        #n;
          ...
          this.wasClosedByWebview ||
            this.#h
              ?.execute("external_close", {
                ok: !e.wasCancelled,
                output: e.output || "cancel",
              })
              .catch(f.K),
            this.#a.event(
              "webview_close",
              {
                wasClosedByWebview: this.wasClosedByWebview,
                wasLoading: this.loading,
                wasCanceled: e.wasCancelled,
        ...
        async attached() {
          ...
          try {
            ...
            return (
              e instanceof p.ResponseError && (i = e.response.status),
              this.#a.event(
                "webview_timing",
                {
                  route: this.config.route,
                  stage1Duration: Date.now() - o,
                  stage1Error: i,
                  stage2Duration: null,
                },
                s.$9
          ...
          this.iframeEl.addEventListener(
            ...
            (this.iframeEl.src = e.url),
            (this.#h = new w.k1(this.iframeEl.contentWindow, e.origin)),
            this.#h.setHandler("event", (e) => this.#x(e)),
            this.#h.setHandler("error", (e) => this.#f(e)),
            this.#h.setHandler("router_event", (e) => this.#w(e)),
            this.#h.setHandler("resize", (e) => this.#v(e)),
            this.#h.setHandler("view_title", (e) => this.#y(e)),
            this.#h.setHandler("view_collection", (e) => this.#_(e)),
            this.#h.setHandler("close", (e) => this.#k(e)),
            this.#h.setHandler("open_uri", (e) => this.#S(e)),
            this.#h.setHandler("toast_message", (e) => this.#C(e)),
            this.#h.setHandler("set_payment_processing_state", (e) =>
              this.#$(e)
            ),
            this.#b.push(this.#h);
        }
        ...
        handleResize(e, o) {
          (this.iframeEl.width =
            "auto" === o[0] ? e[0].toString() : `${o[0]}px`),
            (this.iframeEl.height =
              "auto" === o[1] ? e[1].toString() : `${o[1]}px`);
        }
        #m(e, o) {
          this.#a.event("webview_dialog_error", { type: e, message: o }, s.$9),
            this.controller.cancel("error");
        }
        #x(e) {
          return this.#a.event(e.name, e.data, e.dispatch), !0;
        }
        #f(e) {
          return this.#m(e.type, e.message), !0;
        }
        #w(e) {
          return (
            this.handleResize(e.size, e.preferredSize),
            "router:navigation:complete" === e.event &&
              (this.#p.dispose(),
              (this.loading = !1),
            ...
            "router:navigation:error" === e.event &&
              this.#m("router-navigation", `Error navigating to "${e.name}"`),
            !0
          );
        }
        #v(e) {
          return this.handleResize(e.size, e.preferredSize), !0;
        }
        #y(e) {
          return (
            ...
            this.#n.publish(
              new u.kx(e.location, e.titleId, e.gameId || null, null, !1)
            ),
            !0
          );
        }
        #_(e) {
          return (
            this.#l.router.navigateToRoute("collection", { slug: e.slug }), !0
          );
        }
        #k(e) {
          return (
            (this.wasClosedByWebview = !0),
            e.refreshAccount && this.#g.refreshAccount(),
            this.controller.close(e.ok, e.output),
            !0
          );
        }
        #S(e) {
          return window.open(e.uri, "_blank"), !0;
        }
        #C(e) {
          return (
            this.#s.toast({
        ...
        async #$(e) {
          return e.processing ? await this.#c.show() : await this.#c.hide(), !0;
        }
      };
      y = (0, i.gn)(
        [
          ...
          (0, i.w6)("design:paramtypes", [
            ...
            d.K,
            g.x,
            v.PaymentProcessingDialogService,
            r.v,
          ]),
        ],
        y
    ...
    "dialogs/welcome-mat-dialog": (e, o, t) => {
      t.r(o),
        t.d(o, { WelcomeMatDialog: () => u, WelcomeMatDialogService: () => p });
      var i = t(70655),
        a = t("aurelia-dialog"),
        l = t("aurelia-framework"),
        n = t(81866),
      ...
      let u = class {
        #a;
        constructor(e, o, t) {
          (this.i18nNumber = e), (this.controller = o), (this.#a = t);
        }
        get cheatCount() {
          return this.catalog
            ? Object.values(this.catalog.games)
                .filter((e) => (0, g.yE)(e.flags, d.p.Active))
                .reduce((e, o) => e + (o.trainer?.cheatCount ?? 0), 0)
            : 0;
        }
        get gameCount() {
          return this.catalog
            ? Object.values(this.catalog.games).filter((e) =>
                (0, g.yE)(e.flags, d.p.Active)
              ).length
            : 0;
        }
        get playedGameCount() {
        ...
        deactivate(e) {
          let o;
          (o = e.wasCancelled && !e.output ? "escape" : e.output),
            this.#a.event("welcome_mat_dismiss", { method: o });
        }
      };
      (0, i.gn)(
        [
    ...
    70824: (e, o, t) => {
      ...
      function a(e) {
        ...
        delete o.services,
          Object.assign(i, o),
          e.services && Object.assign(i.services, e.services);
      }
      const l = i;
    },
  },
