...
(global.webpackChunkWeMod = global.webpackChunkWeMod || []).push([
  [4062],
  {
    27170: (e, t, n) => {
      ...
      const Q = "ACTION_ENABLE_GAME_SAVE_CHEATS";
      function X(e, t, n, s) {
        const a = e.gamePreferences[t] || {
          customHotkeys: {},
          saveCheats: { trainerState: {}, enabled: void 0 },
      ...
      function te(e, t) {
        const n = { ...e.gamePreferences };
        return (
          Object.keys(n).forEach((e) => {
            n[e] = {
              ...n[e],
              saveCheats: {
                enabled: t ? void 0 : n[e].saveCheats?.enabled,
                trainerState: {},
              },
            };
          }),
      ...
      const ze = "ACTION_CLEAR_MAP_SETTINGS";
      function Qe(e) {
    ...
    "store/index": (e, t, n) => {
      ...
      var s = n(27170),
        a = n(70824);
      function o(e) {
        const t = localStorage.getItem(`${a.Z.storageNamespace}:${e}`);
        if (t)
          try {
      ...
      function r(e) {
        localStorage.removeItem(`${a.Z.storageNamespace}:${e}`);
      }
      function i(e) {
      ...
      function A(e) {
        ...
        for (const e of (function* () {
          const e = `${a.Z.storageNamespace}:`;
          for (let t = 0; t < localStorage.length; t++) {
            const n = localStorage.key(t);
            "string" == typeof n &&
              n.startsWith(e) &&
              (yield n.substring(e.length));
          }
        })())
