  ...
  [4553],
  {
    ...
    56372: (t, e, i) => {
      ...
      var s = i(70655),
        ...
        h = i(78681),
        c = i(26478),
        d = i("dialogs/email-dialog"),
        u = i("dialogs/pro-onboarding-dialog"),
        p = i(29242),
      ...
      S = (0, s.gn)(
        [
          ...
          (0, s.w6)("design:paramtypes", [
            ...
            a.h,
            w.F0,
            u.ProOnboardingDialogService,
            d.EmailDialogService,
            v.B,
            c.x,
    ...
    95112: (t, e, i) => {
      ...
      let I = class {
        ...
        #k() {
          ...
          t &&
            (this.#S = (0, v.rk)(async () => {
              if (document.hasFocus() && !d.fF) return;
      ...
      let D = class {
        ...
        #et() {
          this.status === s.Connected &&
            this.#W.send("client-cheat-states", this.#B.cheatStates);
        }
        #wt(t, e) {
          e.push(
            t.onValueSet((t) => {
